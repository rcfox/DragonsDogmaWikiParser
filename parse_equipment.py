...
AUTOGEN_HEADER = '<!-- This markup was autogenerated by the scripts found here: https://github.com/rcfox/DragonsDogmaWikiParser -->'
AUTOGEN_FOOTER = '<!-- End of autogenerated markup. -->'
